...
export default function NewMaintenancePage() {
  ...
  const mutation = useMutation({
    ...
    onError: (err: any) => {
      ...
      toast.error(Array.isArray(msg) ? msg[0] : (msg || err.message || 'Erro ao agendar manutenção'));
    },
  });
    ...
    <div className="mx-auto max-w-3xl space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">Agende uma manutenção para um veículo da frota</p>
        </div>
      </div>
